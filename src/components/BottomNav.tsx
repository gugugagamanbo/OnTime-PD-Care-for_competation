import { Pill, Users, ScanLine, User } from 'lucide-react';
...
const BottomNav = ({ activeTab, onTabChange }: BottomNavProps) => {
  ...
  const tabs = [
    { icon: Pill, label: t('tab.medication'), id: 0 },
    { icon: Users, label: t('tab.careCircle'), id: 1 },
    { icon: ScanLine, label: t('tab.scan'), id: 2 },
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className="flex flex-1 flex-col items-center gap-0.5 px-1 py-1 relative"
            >
              {isActive && (
